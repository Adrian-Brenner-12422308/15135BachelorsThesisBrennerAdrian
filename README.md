...
The survey results are split into location-based folders (the location in which the survey was conducted. Example: AA = Addis Ababa). Each folder holds an INFORMATION file which provides statistical insight into the survey material. If a .pdf file takes too long to load refreshing the page usually helps, this is due to the .pdf's file nature as they are uploaded, not GitHub-coded, files.
